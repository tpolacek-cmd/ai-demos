...
const DEMO_STAGES = [
        ...
        options: [
            {
                ...
                description: 'Portal de pago multi-metodo (tarjeta, SPEI, efectivo, wallets, bancos)',
                page: 'checkout.html',
                flow: 'curp-deeplink',
    ...
    },
    {
        ...
        description: 'Que metodos ofrece el portal (elegi uno o varios)',
        multiSelect: true,
        icon: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="1" y="4" width="22" height="16" rx="2"/><line x1="1" y1="10" x2="23" y2="10"/></svg>',
        options: [
            {
                ...
                description: 'Autoriza el pago desde la app BBVA',
            ...
            {
                id: 'otros-bancos',
                name: 'Pago Automatico Bancario',
                description: 'BBVA, Santander, Nu, Banamex y mas',
                icon: '<svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M3 21h18"/><path d="M5 21V10l7-5 7 5v11"/><path d="M9 21v-6h6v6"/></svg>',
            },
            {
                id: 'card',
                name: 'Tarjeta',
                description: 'Credito o debito (Visa, MC, Amex)',
                icon: '<svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="1" y="4" width="22" height="16" rx="2"/><line x1="1" y1="10" x2="23" y2="10"/></svg>',
            },
            {
                id: 'digital',
                name: 'Pago digital',
                description: 'Nubank, Mercadopago, Revolut y mas',
                icon: '<svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="5" y="2" width="14" height="20" rx="2"/><path d="M12 18h.01"/></svg>',
            },
            {
                id: 'transferencia',
                name: 'Transferencia SPEI',
                description: 'Genera una CLABE y transferi',
                icon: '<svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M17 1l4 4-4 4"/><path d="M3 11V9a4 4 0 0 1 4-4h14"/><path d="M7 23l-4-4 4-4"/><path d="M21 13v2a4 4 0 0 1-4 4H3"/></svg>',
            },
            {
                id: 'efectivo',
                name: 'Efectivo',
                description: 'Referencia para 7-Eleven, farmacias y mas',
                icon: '<svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="6" width="20" height="12" rx="2"/><circle cx="12" cy="12" r="2"/><path d="M6 12h.01M18 12h.01"/></svg>',
            },
        ]
    }
];
